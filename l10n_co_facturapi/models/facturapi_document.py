...
class FacturapiDocument(models.Model):
    ...
    def _fetch_and_process_result(self):
        ...
        if is_ds:
            move.write({
                "l10n_co_cuds": data.get("cufe_cude", ""),
                "l10n_co_ds_qr_code": data.get("qr_code", ""),
                "l10n_co_ds_xml_signed": data.get("xml_signed", ""),
                "l10n_co_ds_application_response": data.get("application_response", ""),
            })
        else:
            move.write({
                "l10n_co_cufe": data.get("cufe_cude", ""),
                "l10n_co_qr_code": data.get("qr_code", ""),
                "l10n_co_xml_signed": data.get("xml_signed", ""),
                "l10n_co_application_response": data.get("application_response", ""),
            })
