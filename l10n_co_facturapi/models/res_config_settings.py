...
class ResConfigSettings(models.TransientModel):
    ...
    l10n_co_software_id = fields.Char(
        related="company_id.l10n_co_software_id",
        readonly=False,
    )
    l10n_co_software_pin = fields.Char(
        related="company_id.l10n_co_software_pin",
        readonly=False,
    )
    l10n_co_software_dv = fields.Char(
        related="company_id.l10n_co_software_dv",
        readonly=False,
    )
    l10n_co_test_set_id = fields.Char(
        related="company_id.l10n_co_test_set_id",
        readonly=False,
    )
